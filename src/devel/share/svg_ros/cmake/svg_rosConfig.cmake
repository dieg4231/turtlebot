...
if("TRUE" STREQUAL "TRUE")
  set(svg_ros_SOURCE_PREFIX /home/savage/catkin_ws/src/svg_ros)
  set(svg_ros_DEVEL_PREFIX /home/savage/catkin_ws/src/devel)
  set(svg_ros_INSTALL_PREFIX "")
  set(svg_ros_PREFIX ${svg_ros_DEVEL_PREFIX})
else()
  set(svg_ros_SOURCE_PREFIX "")
  set(svg_ros_DEVEL_PREFIX "")
  set(svg_ros_INSTALL_PREFIX /usr/local)
...
if(NOT "/home/savage/catkin_ws/src/devel/include " STREQUAL " ")
  set(svg_ros_INCLUDE_DIRS "")
  set(_include_dirs "/home/savage/catkin_ws/src/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'svg_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/savage/catkin_ws/src/svg_ros/${idir}'.  Ask the maintainer 'daniel <daniel@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/savage/catkin_ws/src/devel/lib;/opt/ros/indigo/lib)
...
set(svg_ros_EXPORTED_TARGETS "svg_ros_generate_messages_cpp;svg_ros_generate_messages_lisp;svg_ros_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${svg_ros_dep}_FOUND)
      find_package(${svg_ros_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${svg_ros_dep} REQUIRED ${depend_list})
  endif()
