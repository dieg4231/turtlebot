...
(cl:defmethod cl:initialize-instance :after ((m <MVServ-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MVServ-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name svg_ros-srv:<MVServ-request> is deprecated: use svg_ros-srv:MVServ-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <MVServ-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MVServ-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name svg_ros-srv:<MVServ-response> is deprecated: use svg_ros-srv:MVServ-response instead.")))
