...
;//! \htmlinclude InputsSrv-request.msg.html

(cl:defclass <InputsSrv-request> (roslisp-msg-protocol:ros-message)
  ((origin_x
    :reader origin_x
    :initarg :origin_x
    :type cl:float
...
(cl:defclass InputsSrv-request (<InputsSrv-request>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <InputsSrv-request>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'InputsSrv-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name svg_ros-srv:<InputsSrv-request> is deprecated: use svg_ros-srv:InputsSrv-request instead.")))

(cl:ensure-generic-function 'origin_x-val :lambda-list '(m))
(cl:defmethod origin_x-val ((m <InputsSrv-request>))
...
(cl:defmethod origin_y-val ((m <InputsSrv-request>))
...
(cl:defmethod origin_angRob-val ((m <InputsSrv-request>))
...
(cl:defmethod dest_x-val ((m <InputsSrv-request>))
...
(cl:defmethod dest_y-val ((m <InputsSrv-request>))
...
(cl:defmethod sensorBool-val ((m <InputsSrv-request>))
...
(cl:defmethod num_sensorsInt-val ((m <InputsSrv-request>))
...
(cl:defmethod angle_sensor_orig-val ((m <InputsSrv-request>))
...
(cl:defmethod range_angleRob-val ((m <InputsSrv-request>))
...
(cl:defmethod radiusRob-val ((m <InputsSrv-request>))
...
(cl:defmethod advance-val ((m <InputsSrv-request>))
...
(cl:defmethod max_angle-val ((m <InputsSrv-request>))
...
(cl:defmethod num_steps-val ((m <InputsSrv-request>))
...
(cl:defmethod select-val ((m <InputsSrv-request>))
...
(cl:defmethod largest_sensor-val ((m <InputsSrv-request>))
...
(cl:defmethod pathNAme-val ((m <InputsSrv-request>))
...
(cl:defmethod fileNAme-val ((m <InputsSrv-request>))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <InputsSrv-request>) istream)
  "Deserializes a message object of type '<InputsSrv-request>"
    (cl:let ((bits 0))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<InputsSrv-request>)))
  "Returns string type for a service object of type '<InputsSrv-request>"
...
(cl:defclass <InputsSrv-response> (roslisp-msg-protocol:ros-message)
  ((success
    :reader success
    :initarg :success
    :type cl:integer
...
(cl:defclass InputsSrv-response (<InputsSrv-response>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <InputsSrv-response>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'InputsSrv-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name svg_ros-srv:<InputsSrv-response> is deprecated: use svg_ros-srv:InputsSrv-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <InputsSrv-response>))
  ...
  (success m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <InputsSrv-response>) ostream)
  "Serializes a message object of type '<InputsSrv-response>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <InputsSrv-response>) istream)
  "Deserializes a message object of type '<InputsSrv-response>"
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<InputsSrv-response>)))
  "Returns string type for a service object of type '<InputsSrv-response>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'InputsSrv-response)))
  "Returns full string definition for message of type 'InputsSrv-response"
  (cl:format cl:nil "int32 success~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <InputsSrv-response>))
  (cl:+ 0
     4
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <InputsSrv-response>))
  "Converts a ROS message object to a list"
  (cl:list 'InputsSrv-response
    (cl:cons ':success (success msg))
))
(cl:defmethod roslisp-msg-protocol:service-request-type ((msg (cl:eql 'InputsSrv)))
  'InputsSrv-request)
(cl:defmethod roslisp-msg-protocol:service-response-type ((msg (cl:eql 'InputsSrv)))
  'InputsSrv-response)
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'InputsSrv)))
  "Returns string type for a service object of type '<InputsSrv>"
  "svg_ros/InputsSrv")