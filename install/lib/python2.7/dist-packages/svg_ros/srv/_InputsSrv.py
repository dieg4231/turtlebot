...
class InputsSrvRequest(genpy.Message):
  _md5sum = "a0b6f7ea759edc559d7aa6d97f04a443"
...
"""
  __slots__ = ['origin_x','origin_y','origin_angRob','dest_x','dest_y','sensorBool','num_sensorsInt','angle_sensor_orig','range_angleRob','radiusRob','advance','max_angle','num_steps','select','largest_sensor','pathNAme','fileNAme','flg_noise','flg_real_environment']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       origin_x,origin_y,origin_angRob,dest_x,dest_y,sensorBool,num_sensorsInt,angle_sensor_orig,range_angleRob,radiusRob,advance,max_angle,num_steps,select,largest_sensor,pathNAme,fileNAme,flg_noise,flg_real_environment
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2i.pack(_x.flg_noise, _x.flg_real_environment))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.flg_noise, _x.flg_real_environment,) = _struct_2i.unpack(str[start:end])
      return self
...
class InputsSrv(object):
  ...
  _md5sum = '5cf400e1499a2adc5d3432359ab2d9eb'
